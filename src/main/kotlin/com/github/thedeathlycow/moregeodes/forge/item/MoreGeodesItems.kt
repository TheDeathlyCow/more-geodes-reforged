...
object MoreGeodesItems {
    ...
    val ECHO_LOCATOR: Item by REGISTRY.registerObject("echo_locator") {
        EchoLocator(
            Item.Properties().durability(48)
        )
    }
    ...
    val TUNED_CRYSTAL_LOCATOR: Item by REGISTRY.registerObject("tuned_crystal_locator") {
        TunedCrystalLocator(
            Item.Properties().durability(16)
        )
    }
